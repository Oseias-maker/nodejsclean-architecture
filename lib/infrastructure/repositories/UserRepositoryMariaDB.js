...
const { initModels } = require("../orm/sequelize/models/init-models")
...
module.exports = class extends UserRepository {
  ...
  constructor() {
    super();
    this.db = sequelize;
    this.usuario = this.db.model('usuario');
    this.tipo_usuario = this.db.model('tipo_usuario');
    this.use_roles = this.db.model('user_roles');
  ...
  async find() {
    ...
    const seqUsers = await usuario.findAll({
      include: 
        ['roleId_tipo_usuarios']
